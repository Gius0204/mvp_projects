...
func (tc *TaskCreate) SetEstimatedTime(i int) *TaskCreate {
...
func (tc *TaskCreate) check() error {
	...
	if _, ok := tc.mutation.EstimatedTime(); !ok {
		return &ValidationError{Name: "estimated_time", err: errors.New(`ent: missing required field "Task.estimated_time"`)}
	}
	if _, ok := tc.mutation.CreatedAt(); !ok {
